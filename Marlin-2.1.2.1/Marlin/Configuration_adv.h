...
#define HOMING_BUMP_MM      { 0, 5, 5 }       // (linear=mm, rotational=°) Backoff from endstops after first bump
...
// LCD Print Progress options. Multiple times may be displayed in turn.
  ...
  #define EVENT_GCODE_SD_ABORT "G28 Z G0 X0 Y 120"      // G-code to run on SD Abort Print (e.g., "G28XY" or "G27")
